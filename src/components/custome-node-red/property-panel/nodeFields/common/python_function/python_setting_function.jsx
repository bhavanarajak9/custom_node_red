...
const Pythonsettingfunction = React.memo(() => {
  return (
    <>
      ...
      <div style={{ marginTop: 12 }}>
        <DescriptionLabel>Python Code:</DescriptionLabel>
        <Form.Item name="python_code" style={{ marginBottom: 0 }}>
          <TextArea
            placeholder="write function here"
            rows={4}
